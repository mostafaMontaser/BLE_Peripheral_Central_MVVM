...
object NetworkUtil {
    ...
    val CLIENT_ERROR_MSG = BLEChatApplication.getContext()?.getString(R.string.error_client)
    val NETWORK_ERROR_MSG =
        BLEChatApplication.getContext()?.getString(R.string.no_internet_connection)
    val SERVER_ERROR_MSG =
        BLEChatApplication.getContext()?.getString(R.string.error_server)
